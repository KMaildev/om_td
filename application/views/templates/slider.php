...
<body style="padding:0px; margin:0px; background-color:#fff;font-family:arial,helvetica,sans-serif,verdana,'Open Sans'">
	<script src="<?php echo base_url(); ?>public/assets/js/jssor.slider-28.1.0.min.js" type="text/javascript"></script>
	...
	<div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:1600px;height:800px;overflow:hidden;visibility:hidden;">
		...
		<div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:1600px;height:800px;overflow:hidden;">
			...
			<div>
				<img data-u="image" data-src="<?php echo base_url(); ?>/public/data/slider_2.jpeg" />
			</div>

			<div>
				<img data-u="image" data-src="<?php echo base_url(); ?>/public/data/slider_1.jpeg" />
			</div>

			<div>
				<img data-u="image" data-src="<?php echo base_url(); ?>/public/data/slider_3.jpeg" />
			</div>
